...
class TsMorphProject {
    ...
    async getContractContexts() {
        ...
        contracts = contracts.filter((contract, i, arr) => {
            ...
            if (duplicate) {
                log(`Contract ${contract.name} is duplicated. Removing the last instance of it from React context generation`);
            }
            return !duplicate;
        });
        ...
        contracts = await Promise.all(contracts.map(async (contract) => {
            ...
            if (contract.deploymentFile) {
                ...
                console.log((_a = deploymentFile.receipt) === null || _a === void 0 ? void 0 : _a.contractAddress);
