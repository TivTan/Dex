    ...
    return (
        <div>
            <div className="bg-red-400 p-6 shadow sm:rounded-lg">
                ...
                <div className="p-2 bg-red-200 shadow sm:rounded-lg">
                ...
                <div className="inline-flex items-center justify-center px-3 py-2 border p-2 bg-black sm:rounded-lg">
                    <div className="w-full">
                        
                            <label className="text-white text-xl"> Exchange Rate :   </label>
                            <label className="text-white text-xl">   {rate} </label>
